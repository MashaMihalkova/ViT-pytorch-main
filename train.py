...
def save_model(args, model, accur):
    model_to_save = model.module if hasattr(model, 'module') else model
    # model_checkpoint = os.path.join(args.output_dir, "%s_%s_checkpoint.pkl" %(args.name, accur))
    with open('output/log_acc.txt', 'a+') as the_file:
        the_file.write(f'acc = {accur}\n')
...
def main():
    ...
    parser.add_argument("--pretrained_dir", type=str, default='output/custom_alzheimer_checkpoint.pkl', #"checkpoint/ViT-B_16.npz",
